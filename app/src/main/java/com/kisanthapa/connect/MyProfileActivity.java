        ...
        mUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!image.equals("default")){
                    ...
                    Picasso.get().load(thumb_image).into(mImage);
...
//                thumb_bitmap = new Compressor.compress(context, actualImageFile)
                try {
...
//                thumb_bitmap = new Compressor().compress()
...
//                            final String dwn_url = task.getResult().
